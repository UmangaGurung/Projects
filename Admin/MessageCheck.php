        ...
        <div class="container-graph">
            <form>
              ...
              if (isset($_GET['id'])) {
                ...
                $sql = "SELECT Message FROM contact_us WHERE Query_ID = $queryID";
                $result = $con->query($sql);

                if ($result->num_rows > 0) {
                  $mess = $result->fetch_assoc()["Message"];
                  
                  echo '<textarea name="message" rows=38 cols=38 class="message" style="margin-right:15px;">' . $mess . '</textarea>';
                }else{
