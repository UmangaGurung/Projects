            ...
            <div class="table-view">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="customer-att">Message</th>
                    </tr>
                </thead>
                <?php
                ...
                ?>  
                    <tr>
                        <td class="customer-att"><?=$count?></th>
                        <td class="customer-att"><?=$rows["Name"]?></th>
                        <td class="customer-att"><?=$rows["Email"]?></th>
                        <td class="customer-att"><a href="MessageCheck.php?id=<?= $rows["Query_ID"] ?>">Check</th>
                    </tr>
                <?php
                        $count++;
                     }
