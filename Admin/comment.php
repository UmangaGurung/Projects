        ...
        <div class="container-graph">
          <div class="customer-heading">
            ...
            <div class="table-view">
                ...
                <thead>
                    <tr>
                      <th class="customer-att">Comment ID</th>
                      <th class="customer-att">Username</th>
                      <th class="customer-att">Blog Title</th>
                      <th class="customer-att">Comment</th>
                    </tr>
                </thead>
                <?php
                ...
                ?>  
                  <tr>
                    <td class="customer-att"><?=$rows["Comment_ID"]?></th>
                    <td class="customer-att"><?=$rows["User_Name"]?></th>
                    <td class="customer-att"><?=$rows["Title"]?></th>
                    <td class="customer-att"><a href="CommentCheck.php?id3=<?= $rows["Comment_ID"] ?>">Check</th>
                  </tr>
                <?php
                     }
                }
