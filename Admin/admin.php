    ...
    <div class="container">
      ...
      <div class="container-graph"> 
        ...
        <table class="customer-table">
          <thead>
            <tr>
              <th class="customer-att">S.N.</th>
              <th class="customer-att">Username </th>
              <th class="customer-att">Email</th>
              <th class="customer-att">Phone Number</th>
              <th class="customer-att">Joined Date</th>
          </tr>
        </thead>
        <?php
          require_once "../connection.php";

          $sql="SELECT * FROM registed_user WHERE Role_ID=3 OR Role_ID=2";
        ...
        ?>  
              <tr>
                <td class="customer-att"><?=$count?></td>
                <td class="customer-att"><?=$rows["User_Name"]?></td>
                <td class="customer-att"><?=$rows["Email"]?></td>
                <td class="customer-att"><?=$rows["phone_no"]?></td>
                <td class="customer-att"><?=$rows["join_date"]?></td>
              </tr>
        <?php
              $count++;
            }
